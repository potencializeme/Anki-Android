...
import com.ankipro2.anki.multimediacard.beolingus.parsing.BeolingusParser;
import com.ankipro2.anki.multimediacard.language.LanguageListerBeolingus;
...
public class LoadPronounciationActivity extends Activity implements OnCancelListener {
    ...
    // Must be passed in
    public static String EXTRA_SOURCE = "com.ankipro2.anki.LoadPronounciationActivity.extra.source";
    // Passed out as a result
    public static String EXTRA_PRONUNCIATION_FILE_PATH = "com.ankipro2.anki.LoadPronounciationActivity.extra.pronun.file.path";
