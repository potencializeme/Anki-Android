...
import com.x3wiser.compat.customtabs.CustomTabActivityHelper;
import com.x3wiser.compat.customtabs.CustomTabsFallback;
import com.x3wiser.compat.customtabs.CustomTabsHelper;
...
public class CompatV16 extends CompatV15 implements Compat {
    ...
    */
    ...
    public Uri getExportUri(Context context, File file) {
        ...
        return FileProvider.getUriForFile(context, "com.x3wiser.anki.apkgfileprovider", file);
    }
}