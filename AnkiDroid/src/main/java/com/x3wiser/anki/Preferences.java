...
import com.x3wiser.libanki.hooks.AdvancedStatistics;
import com.x3wiser.themes.Themes;
import com.x3wiser.ui.AppCompatPreferenceActivity;
import com.x3wiser.ui.SeekBarPreference;
import com.x3wiser.anim.ActivityTransitionAnimation;
import com.x3wiser.anki.exception.StorageAccessException;
import com.x3wiser.compat.CompatHelper;
import com.x3wiser.libanki.Collection;
import com.x3wiser.libanki.Utils;
import com.x3wiser.libanki.hooks.ChessFilter;
import com.x3wiser.libanki.hooks.HebrewFixFilter;
import com.x3wiser.libanki.hooks.Hooks;
import com.x3wiser.preferences.NumberRangePreference;
import com.x3wiser.utils.LanguageUtil;
    ...
    private void initSubscreen(String action, PreferenceContext listener) {
        ...
        switch (action) {
            ...
            case "com.x3wiser.anki.prefs.custom_buttons":
                ...
                break;
            case "com.x3wiser.anki.prefs.advanced":
                ...
                customSyncServerPreference.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                    public boolean onPreferenceClick(Preference preference) {
                        Intent i = CompatHelper.getCompat().getPreferenceSubscreenIntent(Preferences.this,
                                "com.x3wiser.anki.prefs.custom_sync_server");
                        startActivity(i);
                        return true;
                    }
                });
                ...
                advancedStatisticsPreference.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                    public boolean onPreferenceClick(Preference preference) {
                        Intent i = CompatHelper.getCompat().getPreferenceSubscreenIntent(Preferences.this,
                                "com.x3wiser.anki.prefs.advanced_statistics");
                        startActivity(i);
                        return true;
                    }
                });
                ...
                break;
            case "com.x3wiser.anki.prefs.custom_sync_server":
                ...
                break;
            case "com.x3wiser.anki.prefs.advanced_statistics":
        ...
        try {
            ...
            switch (key) {
                ...
                case "providerEnabled": {
                    ComponentName providerName = new ComponentName(this, "com.x3wiser.anki.provider.CardContentProvider");
