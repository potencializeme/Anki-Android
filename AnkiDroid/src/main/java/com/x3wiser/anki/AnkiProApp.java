...
import com.x3wiser.anki.dialogs.AnkiDroidCrashReportDialog;
...
@ReportsCrashes(
        ...
        additionalSharedPreferences = {"com.x3wiser.anki"},
...
public class AnkiProApp extends Application {
    ...
    public static final String XML_CUSTOM_NAMESPACE = "http://arbitrary.app.namespace/com.x3wiser.anki";
