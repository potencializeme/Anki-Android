...
package com.x3wiser.anki.multimediacard.fields;
...
import com.x3wiser.anki.multimediacard.activity.LoadPronounciationActivity;
import com.x3wiser.anki.multimediacard.activity.PickStringDialogFragment;
import com.x3wiser.anki.multimediacard.activity.TranslationActivity;
...
public class BasicTextFieldController extends FieldControllerBase implements IFieldController,
    ...
    /*
     * (non-Javadoc)
     * @see com.x3wiser.anki.IFieldController#onActivityResult(int, int, android.content.Intent) When activity started
