...
import com.x3wiser.anki.multimediacard.beolingus.parsing.BeolingusParser;
import com.x3wiser.anki.multimediacard.language.LanguageListerBeolingus;
import com.x3wiser.anki.runtimetools.TaskOperations;
import com.x3wiser.anki.web.HttpFetcher;
...
public class LoadPronounciationActivity extends Activity implements OnCancelListener {
    ...
    // Must be passed in
    public static String EXTRA_SOURCE = "com.x3wiser.anki.LoadPronounciationActivity.extra.source";
    // Passed out as a result
    public static String EXTRA_PRONUNCIATION_FILE_PATH = "com.x3wiser.anki.LoadPronounciationActivity.extra.pronun.file.path";
